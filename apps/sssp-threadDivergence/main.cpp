...
int main(int argc, char** argv) {
  ...
  // preprocessing the graph to reduce the thread-divergence due to structure (load imbalance).
  // IMP TODO: Make sure the original input graph, as well as, the replicated graph has no parallel edges.

  //reduceThreadDivergence(G); // this will modify the graph
